...
All information for developers using RNDflo-contracts should consult this document.

## Install

```
npm install --save RNDflo-contracts
```

## Usage

```js
// require the RNDflo contracts repo and instantiate it
const Contracts = require('RNDflo-contracts');
