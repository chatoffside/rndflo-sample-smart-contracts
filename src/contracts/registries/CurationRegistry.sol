...
/*
The curation registry is used for curating RNDflo campaigns. Anyone can technically use
this registry, to curate any number of campaign contract ID's. The RNDflo UI
will only be responsive to curation done by RNDflo, at the begining.
*/
...
/// @title Curation Registry, used to curate RNDflo campaigns
