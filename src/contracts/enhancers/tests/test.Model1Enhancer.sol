...
contract TestModel1Enhancer_deployment is Test {
  ...
  function test_noFundersDeployment() {
    IssuedToken token = new IssuedToken(addrs, amounts, 0, 0, address(this), "RNDflo Tokens", 10, "NT");
...
contract TestModel1Enhancer_atStageOperational is Test {
  ...
  function setup() {
    ...
    // build initial token
    token = new IssuedToken(addrs, amounts, 0, 0, address(this), "RNDflo Tokens", 10, "NT");
